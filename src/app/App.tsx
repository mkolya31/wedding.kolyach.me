...
const CONFIG = {
    ...
    form: {
        ...
        mainCourseOptions: ["Ризотто с ростбифом", "Ризотто карри с лососем и эспуме из угря", "Утиная ножка конфи", "Сибас с пюре из корня сельдерея", "Стейк из телятины со свеклой и черной смородиной", "Рёбра кальби с папоротником", "Стейк Шато Бриан"],
    },
};
// ─────────────────────────────────────────────────────────────────────────────
